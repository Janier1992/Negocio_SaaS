          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <div className="space-y-2">
                ...
                />
                {formErrors.telefono && (
                  <p className="text-xs text-red-600">{formErrors.telefono}</p>
                )}
              </div>
            ...
            {editingCliente ? (
              <div className="flex gap-2">
                <Button onClick={guardarEdicion} disabled={updating || !nombre.trim()}>
                  {updating ? "Guardando..." : "Guardar cambios"}
                </Button>
                <Button variant="secondary" onClick={cancelarEdicion} disabled={updating}>
                  Cancelar
                </Button>
              </div>
            ) : (
              <Button onClick={crearCliente} disabled={saving || !nombre.trim()}>
          ...
          <CardContent>
            <div className="flex flex-col md:flex-row md:items-end gap-4 mb-4">
              ...
              <div className="flex items-center gap-2">
                ...
                />
                <label htmlFor="solo-frecuentes" className="text-sm">
                  Solo frecuentes
                </label>
              </div>
            </div>
                    ...
                    <TableRow key={c.id}>
                      ...
                      <TableCell className="text-right">
                        <div className="flex justify-end gap-2">
                          ...
                          <Button variant="destructive" onClick={() => eliminarCliente(c)}>
                            Eliminar
                          </Button>
                        </div>
                      </TableCell>
